...
declare module "@salesforce/apex/SBP_AccountApplicationCmpCtrl.sendRequestWithPreviousAnswers" {
  export default function sendRequestWithPreviousAnswers(param: {accountId: any, brand: any, distributorAccountId: any, distributorContactId: any, NationalAccountFlag: any}): Promise<any>;
}
