({
    doInit: function (component, event, helper) {
        ...
        { fieldName: "pr_amount", label: "PR Amount", type: "currency", colKey: "pr_amount", exportable: true },
    ...
    downloadExcel: function (component, event, helper) {
        ...
        if(clickedBtn == 'export'){
            // get the Records list from 'filterData' attribute 
            prData = component.get("v.filterData");   
            // get the Records list from 'filterData' attribute 
            attData = component.get("v.filterAttachmentData"); 
        }
        else{
